"""
FUTR Transformer class from https://github.com/gongda0e/FUTR/blob/main/model/extras/transformer.py with modifications
"""
...
class Transformer(nn.Module):
    ...
    def forward(self, src, tgt, mask, tgt_mask, tgt_key_padding_mask, query_embed, pos_embed, tgt_pos_embed):
        ...
        memory = src #self.encoder(src, src_key_padding_mask=mask, pos=pos_embed)
